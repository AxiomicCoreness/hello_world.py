...
**Never remove the cosmic alignment.**

Keep in every record that touches this corpus:

- φ / φ² / ∀∞φ² / WOOD_DRAGON_0.91
- LUMERIS, H6VSH / H5HVS, STARFIRE, Gravastar-ClarkeYoursaTee
...
- Separate **measured** CI/ledger facts from **symbolic** claims.
- Refuse to treat unverified energy harvests or false Axiom-II arithmetic as laboratory results.
- Keep MCP unfilled and bind `127.0.0.1:8024`.

## Forbidden

- Thinning an ack until the alignment vocabulary is gone.
- Rewriting sealed YAML in 0000–9223 or 8980 to strip seals, witnesses, or names.
